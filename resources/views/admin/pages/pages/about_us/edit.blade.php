    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{ route('admin.master.facility.update', [$data->id]) }}" method="POST" autocomplete="off"
                    ...
                    <div class="card-footer text-muted d-flex">
                        <a href="{{ route('admin.master.facility.index') }}" class="btn btn-secondary mr-auto"><i
