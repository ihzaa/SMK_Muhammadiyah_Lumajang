            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-primary" href="{{ route('admin.master.announcement.create') }}"><i
                    ...
                    <table class="table table-bordered" id="main-table">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th></th>
                                <th>
                                    @include('layouts.data_tables.th_general_status',['model'=>'\App\Models\Master\Announcement'])
                                </th>
                                <th></th>
                            </tr>
                        </thead>
