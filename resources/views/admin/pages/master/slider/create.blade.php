    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{ route('admin.master.slider.store') }}" method="POST" autocomplete="off"
                    class="mb-0" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <img id="blah" class="img-fluid m-auto" src="{{ asset('assets/images/picture.svg') }}"
                                    alt="your image" />
                            </div>
                            <div class="col-md-8">
                                ...
                                <div class="custom-file mb-5">
                                    <input type="file" class="custom-file-input" id="imgInp" required name="image">
                    ...
                    <div class="card-footer text-muted d-flex">
                        <a href="{{ route('admin.master.slider.index') }}" class="btn btn-secondary mr-auto"><i
